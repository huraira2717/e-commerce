...
export default function Example() {
  ...
  const [email , setEmail] = useState("");
    ...
    const login=(e) =>{
        ...
        const findUser = getUsers.find((value)=> value.email === email);
        ...
        getUsers.push(newUser)
            alert('New User signup Successfully');
    ...
    return (
      <>
        <div className="flex h-[100vh] flex-1 flex-col justify-center px-6 py-12 bg-gray-800 lg:px-8">
